...
namespace ECommerce.Api.Products.Providers
{
    ...
    public class ProductsProvider : IProductsProvider
    {
        ...
        private void SeedData()
        {
            ...
            {
                _dbContext.Products.Add(new Db.Product() { Id = 1, Name = "Keyboard", Price = 24, Inventory = 100 });
                _dbContext.Products.Add(new Db.Product() { Id = 2, Name = "Mouse", Price = 9, Inventory = 150 });
